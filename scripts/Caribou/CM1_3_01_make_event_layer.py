...
# This was originally built to update PIAM, but I've modified it for CM1.3 work.
...
# what is event layer: it is the one layer that describes all AR and Nat Dist events happened during year X to year Y (user input)
# what happens when disturbances intersect?
# self intersects will be isolated, sorted by year (descending), then only the latest disturbance will be kept.
...
if __name__ == '__main__':
	...
	out_event_gdb = r'C:\Users\KimDan\Government of Ontario\Caribou Explorer - CM1_3\Data\Analysis\EventLayers\Event2002to2023.gdb' # this must already exist - it can be just an empty gdb with whatever name you want
	...
	'EST': "AR_YEAR > 2001",
	'SGR': "AR_YEAR > 2001",
	'NAT': "YEAR > 2001 AND SOURCE in ('FIRE','Weather')", # do fire and weather only because insect damage doesn't necessarily kill all the trees.
	# 'NAT': "YEAR >= 2015",
	} # 
	...
	step_list = 'ALL'
	# step_list = ['NAT1','NAT2','AR1','AR2','AR2-1','AR3','AR4','AR5','AR5-2']
	step_list = ['NAT3','AR5','AR5-2','AR6','NEO1','NEO2','NEO3','NEO4']
	...
	tool_shortname = 'Make_Event_Layer_for_CM1_3' # the output logfile will include this text in its filename.
