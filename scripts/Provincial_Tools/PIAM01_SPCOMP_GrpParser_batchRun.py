...
if __name__ == '__main__':
	...
	input_ari_gdb = r'C:\Users\kimdan\Government of Ontario\Forest Explorer - FRO\FRO2026\02InventoryCleanUp\ARI_base.gdb'
	output_gdb = r'C:\Users\kimdan\Government of Ontario\Forest Explorer - FRO\FRO2026\02InventoryCleanUp\ARI_wFU.gdb'
	...
	# mu_list = ['Park_EagleSnowshoe'] # test

	spfield = 'SPCOMP'
	spc_group_method = 'spc_grp_orig'

	######### logfile stuff

	tool_shortname = 'SpcParser2_BATCHRUN' # the output logfile will include this text in its filename.
	...
	arcpy.env.workspace = input_ari_gdb
	for mu in mu_list:
		inputfc = mu
		outputfc = os.path.join(output_gdb,mu)
